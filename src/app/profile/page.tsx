    ...
    <div>
      ...
      <div className="p-4">
        ...
        <div className="mt-4 flex flex-col items-center gap-3">
          {profile?.role !== 'admin' && (
            <Link href="/history" className="action-btn flex items-center gap-3 w-44 justify-center bg-white text-blue-600 py-3 px-4 rounded-lg border border-blue-200 shadow-sm">
          ...
          <Link href="/profile/personal" className="action-btn flex items-center gap-3 w-44 justify-center bg-white text-blue-600 py-3 px-4 rounded-lg border border-blue-200 shadow-sm">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
          ...
          <Link href="/contact" className="action-btn flex items-center gap-3 w-44 justify-center bg-white text-blue-600 py-3 px-4 rounded-lg border border-blue-200 shadow-sm">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
