...
export default function AdminDashboardPage() {
  ...
  return (
    <div className="p-4">
      <h1 className="text-lg font-semibold mb-3">Dashboard Admin</h1>
      <div className="mb-3 space-x-2">
        <a href="/admin/loans" className="px-3 py-2 bg-blue-600 text-white rounded-lg">Quản lý hồ sơ vay</a>
      </div>
